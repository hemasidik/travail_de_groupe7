...
**Hema Dilofa A. C. Sidik** : 'Im the leader and for this project I helped to write the header to code line(1-117) and the deadline line(1205-1265) ,I also write a part of the readme.

**kinda Fabiola**: she writes the product part line (230-475) she also writes a part of readme

**kinda Roukieta** : she writes the part of sales management alerts line(902-1129)

 **Kindo Andrea**: she writes the part of shopitems and persistance line(119-229) and Line(577-655)

**kiendrebeogo Mashoud** : he writes the perishable product and ajout part, line(476-576) and line(656-745)

**Kima Meliane** : she writes catalogue and rapport part of this project Line(746-901) and line(1130-1204) ,she also writes a part of readme
...
## Table of Contents
 ...
 [OOP Architecture](#OOPArchitecture)
...
| Module | capabilities |
|--------| -------- |
|Products | Add(standard or perishable), edit,delete,search |
|Sales | Multi-item cart, auto stock deduction,profit tracking |
| Alets | Out-of-stock, low stock,expired product detection |
| reports | Revenue KPIs, best sellers, category break down |
...
|--------| --------|
| Encapsulation | All attributes are private, controlled via @property decorators |
| Inhertance | Each child calls super().__ init() and extends the parent |
| Polymorphism | get_status() overriden at each level :ShopItem , Product, PerishableProduct |
| Abstraction | Callers use sell(),add_stock() without knowing the implementation |
## Modules
### Products Module
